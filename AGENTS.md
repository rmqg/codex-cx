...
7. Update the local installed version after the push with `npm install -g github:rmqg/codex-multi-account`, unless the user requests a different local update command.
